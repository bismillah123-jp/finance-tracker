...
export default function AddTransactionModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (isNaN(parsedAmount) || parsedAmount <= 0) {
      toast({ title: "Jumlah tidak valid", description: "Masukkan jumlah yang benar", variant: "destructive" });
      return;
    }
    if (!category) {
      ...
      <DialogContent className="max-w-md w-full">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground text-sm">
            {isEditing ? "Perbarui detail transaksi kamu" : "Catat pemasukan atau pengeluaran baru"}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-9 bg-secondary/50 border-border text-right tabular-nums"
              />
            </div>
          </div>
