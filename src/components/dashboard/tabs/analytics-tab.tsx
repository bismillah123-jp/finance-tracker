  ...
  return (
    <div className="min-h-screen px-4 pt-4 pb-4">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        {/* View toggle — labeled clearly as income/expense, NOT login/logout */}
      ...
      <motion.div
        ...
        className={cn(
          "glass rounded-2xl p-5 border mb-5",
      ...
      >
        <p className="text-foreground text-sm font-semibold mb-4">Tren 6 Bulan Terakhir</p>
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -10, bottom: 0 }}>
            ...
            <XAxis dataKey="month" tick={{ fill: "var(--text-muted, #6b7280)", fontSize: 10 }} axisLine={false} tickLine={false} />
            <YAxis tick={{ fill: "var(--text-muted, #6b7280)", fontSize: 9 }} axisLine={false} tickLine={false} tickFormatter={(v: number) => `${(v / 1e6).toFixed(0)}jt`} />
            <Tooltip content={<CustomTooltip />} />
            <Area type="monotone" dataKey="Pemasukan" stroke="#10b981" strokeWidth={2} fill="url(#gIncome)" dot={false} activeDot={{ r: 4 }} />
            <Area type="monotone" dataKey="Pengeluaran" stroke="#f43f5e" strokeWidth={2} fill="url(#gExpense)" dot={false} activeDot={{ r: 4 }} />
          </AreaChart>
        </ResponsiveContainer>
      </motion.div>
      ...
      {pieData.length > 0 ? (
        <>
          <motion.div
            ...
            className="glass rounded-2xl p-4 border border-border mb-5"
          >
            <p className="text-foreground text-sm font-semibold mb-3">Breakdown Kategori</p>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-1.5 bg-secondary rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(item.value / (pieData[0]?.value || 1)) * 100}%`,
